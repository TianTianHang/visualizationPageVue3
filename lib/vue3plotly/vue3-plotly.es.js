import N from "plotly.js-dist-min";
...
})), ct = ["restyle", "relayout", "update", "addTraces", "deleteTraces", "moveTraces", "extendTraces", "prependTraces", "purge"], ut = ct.reduce((v, E) => (v[E] = function(..._) {
...
const ft = /-(\w)/g, ht = at((v) => v.replace(ft, (E, _) => _ ? _.toUpperCase() : ""));
...
function lt() {
  return J || (J = 1, function(v, E) {
    (function(_, A) {
      ...
      function l(c, f) {
        var a = Object.prototype.toString.call(c), y = a === "[object Array]" || a === "[object NodeList]" || a === "[object HTMLCollection]" || a === "[object Object]" || typeof jQuery < "u" && c instanceof jQuery || typeof Elements < "u" && c instanceof Elements, w = 0, h = c.length;
        if (y)
          for (; w < h; w++)
            f(c[w]);
        else
      ...
      var r = function(c, f) {
        ...
        function w(h, m) {
          if (!!h) {
            ...
            q(o, "scroll", F), q(e, "scroll", F), a = A(function() {
              a = 0, k();
            });
          }
        }
      ...
      if (r.reset = function(c) {
        ...
        l(c, function(a) {
          !a || a.resizedAttached && typeof f == "function" && (a.resizedAttached.remove(f), a.resizedAttached.length()) || a.resizeSensor && (a.contains(a.resizeSensor) && a.removeChild(a.resizeSensor), delete a.resizeSensor, delete a.resizedAttached);
        });
      }, typeof MutationObserver < "u") {
        var u = new MutationObserver(function(c) {
          for (var f in c)
            if (c.hasOwnProperty(f))
              for (var a = c[f].addedNodes, y = 0; y < a.length; y++)
                a[y].resizeSensor && r.reset(a[y]);
        });
...
function pt() {
  if (X)
    return U;
  X = 1;
  var v = "Expected a function", E = 0 / 0, _ = "[object Symbol]", A = /^\s+|\s+$/g, i = /^[-+]0x[0-9a-f]+$/i, l = /^0b[01]+$/i, t = /^0o[0-7]+$/i, n = parseInt, r = typeof {} == "object" && {} && {}.Object === Object && {}, u = typeof self == "object" && self && self.Object === Object && self, c = r || u || Function("return this")(), f = Object.prototype, a = f.toString, y = Math.max, w = Math.min, h = function() {
    return c.Date.now();
  };
  function m(e, d, g) {
  ...
  function o(e) {
    return typeof e == "symbol" || T(e) && a.call(e) == _;
  }
  function s(e) {
    if (typeof e == "number")
      return e;
...
(function(v, E) {
  (function(_, A) {
    ...
    return function(i) {
      ...
      var n, r, u;
      (function(c, f) {
        r = [i, l, t(10), t(38), t(39), t(9), t(37)], n = f, u = typeof n == "function" ? n.apply(l, r) : n, u !== void 0 && (i.exports = u);
      })(this, function(c, f, a, y, w) {
        function h(p) {
        ...
        var e = h(a), d = h(y), g = h(w), I = g.default.debounce, x = I === void 0 ? g.default : I, z = 150;
      ...
      var n, r, u;
      (function(c, f) {
        r = [], n = f, u = typeof n == "function" ? n.apply(l, r) : n, u !== void 0 && (i.exports = u);
      })(this, function() {
        Array.prototype.find || Object.defineProperty(Array.prototype, "find", { value: function(c) {
          if (this == null)
            throw new TypeError('"this" is null or not defined');
          var f = Object(this), a = f.length >>> 0;
          if (typeof c != "function")
            throw new TypeError("predicate must be a function");
          for (var y = arguments[1], w = 0; w < a; ) {
            var h = f[w];
            if (c.call(y, h, w, f))
              return h;
            w++;
      ...
      var n = t(8), r = t(32), u = t(31);
      i.exports = function(c) {
        return function(f, a, y) {
          var w, h = n(f), m = r(h.length), O = u(y, m);
          if (c && a != a) {
            for (; m > O; )
              if (w = h[O++], w != w)
                return !0;
      ...
      var n = t(5), r = t(4).document, u = n(r) && n(r.createElement);
      i.exports = function(c) {
      ...
      var n = t(4), r = t(1), u = t(16), c = t(21), f = "prototype", a = function(y, w, h) {
        var m, O, T, o = y & a.F, s = y & a.G, e = y & a.S, d = y & a.P, g = y & a.B, I = y & a.W, x = s ? r : r[w] || (r[w] = {}), z = x[f], p = s ? n : e ? n[w] : (n[w] || {})[f];
        s && (h = w);
        for (m in h)
          O = !o && p && p[m] !== void 0, O && m in x || (T = O ? p[m] : h[m], x[m] = s && typeof p[m] != "function" ? h[m] : g && O ? u(T, n) : I && p[m] == T ? function(b) {
            ...
            return R[f] = b[f], R;
          }(T) : d && typeof T == "function" ? u(Function.call, T) : T, d && ((x.virtual || (x.virtual = {}))[m] = T, y & a.R && z && !z[m] && c(z, m, T)));
      };
      a.F = 1, a.G = 2, a.S = 4, a.P = 8, a.B = 16, a.W = 32, a.U = 64, a.R = 128, i.exports = a;
    }, function(i, l) {
      ...
      var n = t(24), r = t(28);
      i.exports = t(2) ? function(u, c, f) {
        return n.f(u, c, r(1, f));
      } : function(u, c, f) {
        return u[c] = f, u;
      };
    }, function(i, l, t) {
      ...
      var n = t(13), r = t(22), u = t(34), c = Object.defineProperty;
      l.f = t(2) ? Object.defineProperty : function(f, a, y) {
        if (n(f), a = u(a, !0), n(y), r)
          try {
            return c(f, a, y);
          } catch {
          }
        ...
        return "value" in y && (f[a] = y.value), f;
      };
    }, function(i, l, t) {
      var n = t(20), r = t(8), u = t(14)(!1), c = t(29)("IE_PROTO");
      i.exports = function(f, a) {
        var y, w = r(f), h = 0, m = [];
        for (y in w)
          y != c && n(w, y) && m.push(y);
        for (; a.length > h; )
          n(w, y = a[h++]) && (~u(m, y) || m.push(y));
        return m;
      };
    }, function(i, l, t) {
      var n = t(25), r = t(18);
      ...
      var n = t(19), r = t(1), u = t(3);
      i.exports = function(c, f) {
        var a = (r.Object || {})[c] || Object[c], y = {};
        y[c] = f(a), n(n.S + n.F * u(function() {
          a(1);
        }), "Object", y);
      };
    }, function(i, l) {
      ...
      var n = t(4), r = "__core-js_shared__", u = n[r] || (n[r] = {});
      i.exports = function(c) {
        return u[c] || (u[c] = {});
      };
    }, function(i, l, t) {
      var n = t(7), r = Math.max, u = Math.min;
      i.exports = function(c, f) {
        return c = n(c), c < 0 ? r(c + f, 0) : u(c, f);
      };
    }, function(i, l, t) {
      var n = t(7), r = Math.min;
      i.exports = function(u) {
        return u > 0 ? r(n(u), 9007199254740991) : 0;
      };
    }, function(i, l, t) {
      var n = t(6);
      i.exports = function(r) {
      ...
      i.exports = function(r, u) {
        if (!n(r))
          return r;
        var c, f;
        if (u && typeof (c = r.toString) == "function" && !n(f = c.call(r)) || typeof (c = r.valueOf) == "function" && !n(f = c.call(r)) || !u && typeof (c = r.toString) == "function" && !n(f = c.call(r)))
          return f;
      ...
      (function(t, n) {
        ...
        u.prototype.THROTTLE_TIMEOUT = 100, u.prototype.POLL_INTERVAL = null, u.prototype.USE_MUTATION_OBSERVER = !0, u.prototype.observe = function(o) {
        ...
        }, u.prototype.unobserve = function(o) {
        ...
        }, u.prototype._initThresholds = function(o) {
          var s = o || [0];
        ...
        }, u.prototype._parseRootMargin = function(o) {
        ...
        }, u.prototype._monitorIntersections = function() {
        ...
        }, u.prototype._unmonitorIntersections = function() {
        ...
        }, u.prototype._computeTargetAndRootIntersection = function(o, s) {
        ...
        }, u.prototype._expandRectByRootMargin = function(o) {
        ...
        }, u.prototype._hasCrossedThreshold = function(o, s) {
